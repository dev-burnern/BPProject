...
<body>
    ...
    <main class="container">
        <div class="section-header"><h3>글쓰기</h3></div>
        
        <div class="write-box">
            <form action="${ctx}/board/write" method="post">
                <input type="text" name="title" class="input-title" placeholder="제목을 입력하세요" required>
                <textarea name="content" class="input-content" placeholder="내용을 자유롭게 작성해주세요." required></textarea>
                
                <div style="text-align: right; margin-top: 20px;">
                    <a href="${ctx}/board/list" class="btn-secondary" style="margin-right: 10px;">취소</a>
